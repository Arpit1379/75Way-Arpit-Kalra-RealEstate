                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                    ...
                    <ul className="flex md:flex-1 flex-row font-nunito sm:hidden items-start justify-center md:ml-[0] ml-[470px] w-[30%] md:w-full common-row-list">
                      <li>
                        ...
                        >
                          <Text size="txtNunitoRegular15"><Link to="/">Home</Link></Text>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          <Text size="txtNunitoRegular15"><Link to="/">About</Link></Text>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          <Text size="txtNunitoRegular15"><Link to="/">Property</Link></Text>
                        </a>
                      </li>
                      <li>
                        <a
                      ...
                      <li>
                        <a
                          ...
                          className="ml-[29px] text-[15px] text-blue_gray-900 text-center"
                        >
                          <Text size="txtNunitoRegular15"><Link to="/contact">Contact Us</Link></Text>
                        </a>
                      </li>
                    </ul>
                    <Button
                ...
                <div className="bg-white-A700_3f flex flex-col items-center justify-start p-[9px] rounded-[5px] w-full">
                  <div className="bg-white-A700 flex sm:flex-col flex-row sm:gap-5 items-center justify-start p-3 rounded-[5px] w-full">
                    ...
                    <SelectBox
                      ...
                      variant="outline"
                    />
                    <Button className="cursor-pointer font-medium leading-[normal] min-w-[100px] sm:ml-[0] ml-[22px] rounded-[5px] text-[15px] text-center" color="deep_orange_A200">
